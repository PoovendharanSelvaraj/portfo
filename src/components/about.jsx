...
export const About = () => {
  const resume = ()=>{
    return (
      window.location.href="https://drive.google.com/file/d/13_NHgW49KWm_cqI75iCappRrzxcbh5ra/view?usp=sharing"
    )
  }
  return (
...
software development engineer in a product based company.
        ...
        <div className="git">
          ...
          <a className="giticon" href="https://github.com/PoovendharanSelvaraj"><FaGithub /></a>
          <a href="https://www.linkedin.com/in/poovendharan-s-39a145167/" className="giticon"><FaLinkedin/></a>
        </div>
      </div>
      </div>
    </div>
